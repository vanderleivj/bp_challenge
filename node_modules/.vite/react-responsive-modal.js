...
function useStatefulRef(initialVal = null) {
  let [cur, setCur] = import_react.default.useState(initialVal);
  const { current: ref } = import_react.default.useRef({
    current: cur
  });
...
// dep:react-responsive-modal
var react_responsive_modal_default = react_responsive_modal_esm_default;
export {
  Modal,
  react_responsive_modal_default as default
};
/*!
